...
function AuthProvider({ children }: AuthProviderData) {
  ...
  const CLIENT_ID = process.env.CLIENT_ID ?? 'invalid-client-id';
    ...
    try {
      ...
      if(authResponse.type === 'success' && authResponse.params.error !== "access_denied"){
        ...
        setUser({
          ...
          display_name: userResponse.data.data[3].display_name,
          email: userResponse.data.data[8].email,
          profile_image_url: userResponse.data.data[6].profile_image_url
        });
